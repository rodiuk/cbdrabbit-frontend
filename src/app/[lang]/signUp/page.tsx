	...
	return <main className={cn("container", styles.main)}>
		...
		<div className={styles.lay_item}>
			<div className={styles.items_wrap}>
				...
				<div className={`${styles.ttl} ${styles.mb15}`}>Це твій останній шанс. Далі вже не буде вороття...</div>
				<div className={styles.ttl}>Вибереш червону цукерку - залишишся в дивокраї, вибереш жовту - те ж саме, але бананова</div>
			</div>
		...
		<div className={styles.lay_item}>
			<div className={styles.items_wrap}>
				...
				<div className={styles.ttl}>Ми відправили лист для підтвердження вашої пошти</div>
				<div className={`${styles.descr} ${styles.m10}`}>newzaychyik@gmail.com</div>
				<div className={styles.ttl}>Перейдіть за посиланням у листі, щоб зареєструвати акаунт</div>
			</div>
		...
		<div className={styles.lay_item}>
			...
			<div className={styles.descr}>newzaychyik@gmail.com</div>
				<Input type="text" text="Пароль" placeholder="Введіть пароль" isPassword password={true} />
			{!errorInAccoun && <p className={styles.error}>Неправильно введений пароль або email. Спробуйте ще раз</p>}
		...
		<div className={styles.lay_item}>
			...
			<div className={styles.lay_text}>
				<p>Бажаєте <strong>зареєструватися</strong> і отримати <strong>знижку</strong> на цукерки?</p>
			</div>
			<div className={`${styles.bb} ${styles.two_button}`}>
				<Button text="Назад" className="white_button" iconLeft={true} />
