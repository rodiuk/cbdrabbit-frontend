    ...
    <>
      <main className={cn("container", styles.main)}>
        <div className={styles.wrapper}>
          ...
          <p className={styles.m0}>1.5. У цьому Договорі наведені терміни мають такі значення:</p>
          <ul>
            ...
            <li className={styles.li}>
              ...
              оформленні замовлення на сайті www.cbdrabbit.shop.
				  ...
				  <p className={styles.p}>2.1. На умовах, визначених цим Договором, Продавець зобов'язується передати у власність Покупцю замовлений ним товар, а Покупець зобов'язується оплатити та прийняти відповідний товар.</p>
				  <p className={styles.p}>2.2. Моментом укладення цього Договору (акцептом) та моментом повного й беззаперечного прийняття Покупцем умов Договору вважається момент оформлення Покупцем відповідного замовлення на сайті Інтернет-магазину.</p>
				  <h2 className={styles.h2}>3. Порядок оформлення замовлення</h2>
				  <p className={styles.p}>3.1. Покупець оформлює замовлення в Інтернет-магазині самостійно через форму «Кошик» або, для оптових замовлень, за допомогою електронної пошти чи телефону, вказаних у розділі контактів Інтернет-магазину.</p>
        </div>
		  </main>
		  <Footer />
    </>
